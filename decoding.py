...
class CRF(object):
    ...
    def Viterbi(self):
        ...
        t_range = -1 * np.array(sorted(-1 * np.arange(N)))   #array([2, 1, 0])
        for t in t_range:
            if t == N-1:  # 得到最优状态
...
if __name__ == '__main__':
    ...
    SW = np.array([[1.0, 0.5],  # X1:SW(Y1=1,μ1=1), SW(Y1=2,μ2=0.5)
                   [0.8, 0.5],  # X2:SW(Y2=1,μ3=0.8), SW(Y2=2,μ2=0.5)
                   [0.8, 0.5]])  # X3:SW(Y3=1,μ3=0.8), SW(Y3=2,μ4=0.5)
